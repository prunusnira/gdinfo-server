...
var txtPIU = {
    howto: {
        ...
        "2. <b><font color='red'>반드시 구글 크롬 계열의 브라우저를 사용한다 (모바일도 마찬가지)</font></b><br/>"+
        "3. 「신규유저」나「파일열기」버튼을 눌러 정보를 불러옴<br/>"+
        "4. 난이도/패턴을 선택하여 랭크 정보를 설정<br/>"+
        "5. 「파일저장」버튼을 누르고 CSV 파일을 보관",
        "en":"How to use:<br/>"+
        "1. Only usable for Android and PC (File download problem)<br/>"+
        "2. <b><font color='red'>MUST USE Google Chrome based browsers (Including mobile environment)</font></b><br/>"+
        "3. Load user information with 「New user」 or 「Load File」<br/>"+
        "4. Select levels and patterns to load list, and then click each pattern to set rank status<br/>"+
        "5. 「Save File」 to save your progress via CSV file"
    },
    subtitle: {
        "jp":"記録管理ツール",
        "ko":"기록 관리 툴",
