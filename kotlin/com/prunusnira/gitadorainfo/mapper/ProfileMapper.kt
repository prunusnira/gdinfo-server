...
interface ProfileMapper {
	...
	fun addRival(@Param("myid") myid: Int,
				 @Param("id") id: Int,
				 @Param("gtype") gtype: String)
	
	fun getOneRival(@Param("myid") myid: Int,
					@Param("id") id: Int,
					@Param("gtype") gtype: String): Rival
	
	fun getRivalList(@Param("myid") myid: Int,
					 @Param("gtype") gtype: String): List<RecentUser>
	
	fun delRival(@Param("myid") myid: Int,
				 @Param("id") id: Int,
				 @Param("gtype") gtype: String)
